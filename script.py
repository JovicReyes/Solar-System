...
def spheres(size, clr, dist=0): 
    ...
    # coordinate punti sulla superficie della sfera
...
def orbits(dist, offset=0, clr='white', wdth=2): 
    ...
    # liste vuote per memorizzare i valori x,y,z
    xcrd=[]
    ycrd=[]
    zcrd=[]
...
# Creazione sfere
trace0=spheres(diameter[0], '#ffff00', distance_from_sun[0]) # Sole
trace1=spheres(diameter[1], '#87877d', distance_from_sun[1]) # Mercurio
trace2=spheres(diameter[2], '#d23100', distance_from_sun[2]) # Venere
trace3=spheres(diameter[3], '#325bff', distance_from_sun[3]) # Terra
trace4=spheres(diameter[4], '#b20000', distance_from_sun[4]) # Marte
trace5=spheres(diameter[5], '#ebebd2', distance_from_sun[5]) # Giove
trace6=spheres(diameter[6], '#ebcd82', distance_from_sun[6]) # Saturno
trace7=spheres(diameter[7], '#37ffda', distance_from_sun[7]) # Urano
trace8=spheres(diameter[8], '#2500ab', distance_from_sun[8]) # Nettuno

# tracce orbita
trace11 = orbits(distance_from_sun[1]) # Mercurio
trace12 = orbits(distance_from_sun[2]) # Venere
trace13 = orbits(distance_from_sun[3]) # Terra
trace14 = orbits(distance_from_sun[4]) # Marte
trace15 = orbits(distance_from_sun[5]) # Giove
trace16 = orbits(distance_from_sun[6]) # Saturno
trace17 = orbits(distance_from_sun[7]) # Urano
trace18 = orbits(distance_from_sun[8]) # Nettuno
